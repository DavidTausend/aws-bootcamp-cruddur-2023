...
I added a .dockerignore file in frontend-react-js to exclude unnecessary files and directories from the build context. For example, the node_modules directory and any files that are generated by your text editor or IDE.
